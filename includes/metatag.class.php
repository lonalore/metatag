...
class metatag
{
	...
	function __construct()
	{
		...
		$this->enabled_groups = array_keys(($prefs['groups'] ?? []));
	}
	...
	public function getWidget($values = array(), $field = 'x_metatag_metatags')
	{
		...
		// Basic meta tags.
		if (in_array('basic', $this->enabled_groups)) {
			$basic = array();
		...
		// Advanced meta tags.
		if (in_array('advanced', $this->enabled_groups)) {
			$advanced = [];

			$robots = varset($values['data']['robots'], []);
			...
			$checkboxes .= $tp->lanVars(LAN_METATAG_ADMIN_10_07, [
			...
			$advanced[$field . '[news_keywords]'] = [
				'label' => LAN_METATAG_ADMIN_12,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[news_keywords]', varset($values['data']['news_keywords'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_12,
					'class' => 'input-block-level',
				]),
			];
			...
			$advanced[$field . '[standout]'] = [
				'label' => LAN_METATAG_ADMIN_14,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[standout]', varset($values['data']['standout'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_14,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[rating]'] = [
				'label' => LAN_METATAG_ADMIN_16,
				'help'  => $form->help(LAN_METATAG_ADMIN_17),
				'field' => $form->select($field . '[rating]', [
				...
				], varset($values['data']['rating'], FALSE), [
					'label' => LAN_METATAG_ADMIN_16,
					'class' => 'input-block-level',
				], TRUE),
			];
			...
			$advanced[$field . '[referrer]'] = [
				'label' => LAN_METATAG_ADMIN_18,
				'help'  => $form->help($help),
				'field' => $form->select($field . '[referrer]', [
				...
				], varset($values['data']['referrer'], FALSE), [
					'label' => LAN_METATAG_ADMIN_18,
					'class' => 'input-block-level',
				], TRUE),
			];
			...
			$advanced[$field . '[generator]'] = [
				...
				'field' => $form->text($field . '[generator]', varset($values['data']['generator'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_20,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[rights]'] = [
				'label' => LAN_METATAG_ADMIN_22,
				'help'  => $form->help(LAN_METATAG_ADMIN_23),
				'field' => $form->text($field . '[rights]', varset($values['data']['rights'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_22,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[image_src]'] = [
				'label' => LAN_METATAG_ADMIN_24,
				'help'  => $form->help(LAN_METATAG_ADMIN_25),
				'field' => $form->text($field . '[image_src]', varset($values['data']['image_src'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_24,
					'class' => 'input-block-level',
				]),
			];
			...
			$advanced[$field . '[shortlink]'] = [
				'label' => LAN_METATAG_ADMIN_28,
				'help'  => $form->help(LAN_METATAG_ADMIN_29),
				'field' => $form->text($field . '[shortlink]', varset($values['data']['shortlink'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_28,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[publisher]'] = [
				'label' => LAN_METATAG_ADMIN_30,
				'help'  => $form->help(LAN_METATAG_ADMIN_31),
				'field' => $form->text($field . '[publisher]', varset($values['data']['publisher'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_30,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[author]'] = [
				'label' => LAN_METATAG_ADMIN_32,
				'help'  => $form->help(LAN_METATAG_ADMIN_33),
				'field' => $form->text($field . '[author]', varset($values['data']['author'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_32,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[original-source]'] = [
				'label' => LAN_METATAG_ADMIN_34,
				'help'  => $form->help(LAN_METATAG_ADMIN_35),
				'field' => $form->text($field . '[original-source]', varset($values['data']['original-source'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_34,
					'class' => 'input-block-level',
				]),
			];
			...
			$advanced[$field . '[prev]'] = [
				...
				'help'  => $form->help($help),
				'field' => $form->text($field . '[prev]', varset($values['data']['prev'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_36,
					'class' => 'input-block-level',
				]),
			];
			...
			$advanced[$field . '[next]'] = [
				...
				'help'  => $form->help($help),
				'field' => $form->text($field . '[next]', varset($values['data']['next'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_38,
					'class' => 'input-block-level',
				]),
			];
			...
			$advanced[$field . '[geo.position]'] = [
				'label' => LAN_METATAG_ADMIN_40,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[geo.position]', varset($values['data']['geo.position'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_40,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[geo.placename]'] = [
				'label' => LAN_METATAG_ADMIN_42,
				'help'  => $form->help(LAN_METATAG_ADMIN_43),
				'field' => $form->text($field . '[geo.placename]', varset($values['data']['geo.placename'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_42,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[geo.region]'] = [
				'label' => LAN_METATAG_ADMIN_44,
				'help'  => $form->help(LAN_METATAG_ADMIN_45),
				'field' => $form->text($field . '[geo.region]', varset($values['data']['geo.region'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_44,
					'class' => 'input-block-level',
				]),
			];
			...
			$advanced[$field . '[icbm]'] = [
				...
				'help'  => $form->help($help),
				'field' => $form->text($field . '[icbm]', varset($values['data']['icbm'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_46,
					'class' => 'input-block-level',
				]),
			];

			$advanced[$field . '[refresh]'] = [
				'label' => LAN_METATAG_ADMIN_48,
				'help'  => $form->help(LAN_METATAG_ADMIN_49),
				'field' => $form->text($field . '[refresh]', varset($values['data']['refresh'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_48,
					'class' => 'input-block-level',
				]),
			];
		...
		if (in_array('opengraph', $this->enabled_groups)) {
			$opengraph = [];

			$opengraph[$field . '[og:site_name]'] = [
				'label' => LAN_METATAG_ADMIN_160,
				'help'  => $form->help(LAN_METATAG_ADMIN_161),
				'field' => $form->text($field . '[og:site_name]', varset($values['data']['og:site_name'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_160,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:type]'] = [
				'label' => LAN_METATAG_ADMIN_162,
				'help'  => $form->help(LAN_METATAG_ADMIN_163),
				'field' => $form->select($field . '[og:type]', [
				...
				], varset($values['data']['og:type'], FALSE), [
					'label' => LAN_METATAG_ADMIN_162,
					'class' => 'input-block-level',
				], TRUE),
			];

			$opengraph[$field . '[og:url]'] = [
				'label' => LAN_METATAG_ADMIN_164,
				'help'  => $form->help(LAN_METATAG_ADMIN_165),
				'field' => $form->text($field . '[og:url]', varset($values['data']['og:url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_164,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:title]'] = [
				'label' => LAN_METATAG_ADMIN_166,
				'help'  => $form->help(LAN_METATAG_ADMIN_167),
				'field' => $form->text($field . '[og:title]', varset($values['data']['og:title'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_166,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:determiner]'] = [
				'label' => LAN_METATAG_ADMIN_168,
				'help'  => $form->help(LAN_METATAG_ADMIN_169),
				'field' => $form->select($field . '[og:determiner]', [
					'auto' => LAN_METATAG_ADMIN_168_01,
					'a'    => LAN_METATAG_ADMIN_168_02,
					'an'   => LAN_METATAG_ADMIN_168_03,
					'the'  => LAN_METATAG_ADMIN_168_04,
				], varset($values['data']['og:determiner'], FALSE), [
					'label' => LAN_METATAG_ADMIN_168,
					'class' => 'input-block-level',
				], TRUE),
			];

			$opengraph[$field . '[og:description]'] = [
				'label' => LAN_METATAG_ADMIN_170,
				'help'  => $form->help(LAN_METATAG_ADMIN_171),
				'field' => $form->text($field . '[og:description]', varset($values['data']['og:description'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_170,
					'class' => 'input-block-level',
				]),
			];
			...
			$opengraph[$field . '[og:updated_time]'] = [
				'label' => LAN_METATAG_ADMIN_172,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[og:updated_time]', varset($values['data']['og:updated_time'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_172,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:see_also]'] = [
				'label' => LAN_METATAG_ADMIN_174,
				'help'  => $form->help(LAN_METATAG_ADMIN_175),
				'field' => $form->text($field . '[og:see_also]', varset($values['data']['og:see_also'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_174,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:image]'] = [
				'label' => LAN_METATAG_ADMIN_176,
				'help'  => $form->help(LAN_METATAG_ADMIN_177),
				'field' => $form->text($field . '[og:image]', varset($values['data']['og:image'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_176,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:image:url]'] = [
				'label' => LAN_METATAG_ADMIN_178,
				'help'  => $form->help(LAN_METATAG_ADMIN_179),
				'field' => $form->text($field . '[og:image:url]', varset($values['data']['og:image:url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_178,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:image:secure_url]'] = [
				'label' => LAN_METATAG_ADMIN_180,
				'help'  => $form->help(LAN_METATAG_ADMIN_181),
				'field' => $form->text($field . '[og:image:secure_url]', varset($values['data']['og:image:secure_url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_180,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:image:type]'] = [
				'label' => LAN_METATAG_ADMIN_182,
				'help'  => $form->help(LAN_METATAG_ADMIN_183),
				'field' => $form->text($field . '[og:image:type]', varset($values['data']['og:image:type'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_182,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:image:width]'] = [
				'label' => LAN_METATAG_ADMIN_184,
				'help'  => $form->help(LAN_METATAG_ADMIN_185),
				'field' => $form->text($field . '[og:image:width]', varset($values['data']['og:image:width'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_184,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:image:height]'] = [
				'label' => LAN_METATAG_ADMIN_186,
				'help'  => $form->help(LAN_METATAG_ADMIN_187),
				'field' => $form->text($field . '[og:image:height]', varset($values['data']['og:image:height'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_186,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:latitude]'] = [
				'label' => LAN_METATAG_ADMIN_188,
				'help'  => $form->help(LAN_METATAG_ADMIN_189),
				'field' => $form->text($field . '[og:latitude]', varset($values['data']['og:latitude'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_188,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:longitude]'] = [
				'label' => LAN_METATAG_ADMIN_190,
				'help'  => $form->help(LAN_METATAG_ADMIN_191),
				'field' => $form->text($field . '[og:longitude]', varset($values['data']['og:longitude'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_190,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:street_address]'] = [
				'label' => LAN_METATAG_ADMIN_192,
				'help'  => $form->help(LAN_METATAG_ADMIN_193),
				'field' => $form->text($field . '[og:street_address]', varset($values['data']['og:street_address'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_192,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:locality]'] = [
				'label' => LAN_METATAG_ADMIN_194,
				'help'  => $form->help(LAN_METATAG_ADMIN_195),
				'field' => $form->text($field . '[og:locality]', varset($values['data']['og:locality'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_194,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:region]'] = [
				'label' => LAN_METATAG_ADMIN_196,
				'help'  => $form->help(LAN_METATAG_ADMIN_197),
				'field' => $form->text($field . '[og:region]', varset($values['data']['og:region'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_196,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:postal_code]'] = [
				'label' => LAN_METATAG_ADMIN_198,
				'help'  => $form->help(LAN_METATAG_ADMIN_199),
				'field' => $form->text($field . '[og:postal_code]', varset($values['data']['og:postal_code'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_198,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:country_name]'] = [
				'label' => LAN_METATAG_ADMIN_200,
				'help'  => $form->help(LAN_METATAG_ADMIN_201),
				'field' => $form->text($field . '[og:country_name]', varset($values['data']['og:country_name'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_200,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:email]'] = [
				'label' => LAN_METATAG_ADMIN_202,
				'help'  => $form->help(LAN_METATAG_ADMIN_203),
				'field' => $form->text($field . '[og:email]', varset($values['data']['og:email'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_202,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:phone_number]'] = [
				'label' => LAN_METATAG_ADMIN_204,
				'help'  => $form->help(LAN_METATAG_ADMIN_205),
				'field' => $form->text($field . '[og:phone_number]', varset($values['data']['og:phone_number'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_204,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:fax_number]'] = [
				'label' => LAN_METATAG_ADMIN_206,
				'help'  => $form->help(LAN_METATAG_ADMIN_207),
				'field' => $form->text($field . '[og:fax_number]', varset($values['data']['og:fax_number'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_206,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:locale]'] = [
				'label' => LAN_METATAG_ADMIN_208,
				'help'  => $form->help(LAN_METATAG_ADMIN_209),
				'field' => $form->text($field . '[og:locale]', varset($values['data']['og:locale'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_208,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:locale:alternate]'] = [
				'label' => LAN_METATAG_ADMIN_210,
				'help'  => $form->help(LAN_METATAG_ADMIN_211),
				'field' => $form->text($field . '[og:locale:alternate]', varset($values['data']['og:locale:alternate'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_210,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[article:author]'] = [
				'label' => LAN_METATAG_ADMIN_212,
				'help'  => $form->help(LAN_METATAG_ADMIN_213),
				'field' => $form->text($field . '[article:author]', varset($values['data']['article:author'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_212,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[article:publisher]'] = [
				'label' => LAN_METATAG_ADMIN_214,
				'help'  => $form->help(LAN_METATAG_ADMIN_215),
				'field' => $form->text($field . '[article:publisher]', varset($values['data']['article:publisher'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_214,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[article:section]'] = [
				'label' => LAN_METATAG_ADMIN_216,
				'help'  => $form->help(LAN_METATAG_ADMIN_217),
				'field' => $form->text($field . '[article:section]', varset($values['data']['article:section'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_216,
					'class' => 'input-block-level',
				]),
			];
			...
			// TODO - use selectize instead.
			$opengraph[$field . '[article:tag]'] = [
				'label' => LAN_METATAG_ADMIN_218,
				'help'  => $form->help(LAN_METATAG_ADMIN_219),
				'field' => $form->text($field . '[article:tag]', varset($values['data']['article:tag'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_218,
					'class' => 'input-block-level',
				]),
			];
			...
			$opengraph[$field . '[article:published_time]'] = [
				'label' => LAN_METATAG_ADMIN_220,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[article:published_time]', varset($values['data']['article:published_time'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_220,
					'class' => 'input-block-level',
				]),
			];
			...
			$opengraph[$field . '[article:modified_time]'] = [
				'label' => LAN_METATAG_ADMIN_222,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[article:modified_time]', varset($values['data']['article:modified_time'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_222,
					'class' => 'input-block-level',
				]),
			];
			...
			$opengraph[$field . '[article:expiration_time]'] = [
				'label' => LAN_METATAG_ADMIN_224,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[article:expiration_time]', varset($values['data']['article:expiration_time'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_224,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[profile:first_name]'] = [
				'label' => LAN_METATAG_ADMIN_226,
				'help'  => $form->help(LAN_METATAG_ADMIN_227),
				'field' => $form->text($field . '[profile:first_name]', varset($values['data']['profile:first_name'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_226,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[profile:last_name]'] = [
				'label' => LAN_METATAG_ADMIN_228,
				'help'  => $form->help(LAN_METATAG_ADMIN_229),
				'field' => $form->text($field . '[profile:last_name]', varset($values['data']['profile:last_name'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_228,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[profile:username]'] = [
				'label' => LAN_METATAG_ADMIN_230,
				'help'  => $form->help(LAN_METATAG_ADMIN_231),
				'field' => $form->text($field . '[profile:username]', varset($values['data']['profile:username'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_230,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[profile:gender]'] = [
				'label' => LAN_METATAG_ADMIN_232,
				'help'  => $form->help(LAN_METATAG_ADMIN_233),
				'field' => $form->text($field . '[profile:gender]', varset($values['data']['profile:gender'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_232,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:audio]'] = [
				'label' => LAN_METATAG_ADMIN_234,
				'help'  => $form->help(LAN_METATAG_ADMIN_235),
				'field' => $form->text($field . '[og:audio]', varset($values['data']['og:audio'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_234,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:audio:secure_url]'] = [
				'label' => LAN_METATAG_ADMIN_236,
				'help'  => $form->help(LAN_METATAG_ADMIN_237),
				'field' => $form->text($field . '[og:audio:secure_url]', varset($values['data']['og:audio:secure_url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_236,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:audio:type]'] = [
				'label' => LAN_METATAG_ADMIN_238,
				'help'  => $form->help(LAN_METATAG_ADMIN_239),
				'field' => $form->text($field . '[og:audio:type]', varset($values['data']['og:audio:type'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_238,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[book:author]'] = [
				'label' => LAN_METATAG_ADMIN_240,
				'help'  => $form->help(LAN_METATAG_ADMIN_241),
				'field' => $form->text($field . '[book:author]', varset($values['data']['book:author'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_240,
					'class' => 'input-block-level',
				]),
			];
			...
			$opengraph[$field . '[book:isbn]'] = [
				'label' => LAN_METATAG_ADMIN_242,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[book:isbn]', varset($values['data']['book:isbn'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_242,
					'class' => 'input-block-level',
				]),
			];
			...
			$opengraph[$field . '[book:release_date]'] = [
				'label' => LAN_METATAG_ADMIN_244,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[book:release_date]', varset($values['data']['book:release_date'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_244,
					'class' => 'input-block-level',
				]),
			];
			...
			// TODO - use selectize instead.
			$opengraph[$field . '[book:tag]'] = [
				'label' => LAN_METATAG_ADMIN_246,
				'help'  => $form->help(LAN_METATAG_ADMIN_247),
				'field' => $form->text($field . '[book:tag]', varset($values['data']['book:tag'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_246,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:video:url]'] = [
				'label' => LAN_METATAG_ADMIN_248,
				'help'  => $form->help(LAN_METATAG_ADMIN_249),
				'field' => $form->text($field . '[og:video:url]', varset($values['data']['og:video:url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_248,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:video:secure_url]'] = [
				'label' => LAN_METATAG_ADMIN_250,
				'help'  => $form->help(LAN_METATAG_ADMIN_251),
				'field' => $form->text($field . '[og:video:secure_url]', varset($values['data']['og:video:secure_url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_250,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:video:width]'] = [
				'label' => LAN_METATAG_ADMIN_252,
				'help'  => $form->help(LAN_METATAG_ADMIN_253),
				'field' => $form->text($field . '[og:video:width]', varset($values['data']['og:video:width'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_252,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:video:height]'] = [
				'label' => LAN_METATAG_ADMIN_254,
				'help'  => $form->help(LAN_METATAG_ADMIN_255),
				'field' => $form->text($field . '[og:video:height]', varset($values['data']['og:video:height'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_254,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[og:video:type]'] = [
				'label' => LAN_METATAG_ADMIN_256,
				'help'  => $form->help(LAN_METATAG_ADMIN_257),
				'field' => $form->text($field . '[og:video:type]', varset($values['data']['og:video:type'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_256,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:actor]'] = [
				'label' => LAN_METATAG_ADMIN_258,
				'help'  => $form->help(LAN_METATAG_ADMIN_259),
				'field' => $form->text($field . '[video:actor]', varset($values['data']['video:actor'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_258,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:actor:role]'] = [
				'label' => LAN_METATAG_ADMIN_260,
				'help'  => $form->help(LAN_METATAG_ADMIN_261),
				'field' => $form->text($field . '[video:actor:role]', varset($values['data']['video:actor:role'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_260,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:director]'] = [
				'label' => LAN_METATAG_ADMIN_262,
				'help'  => $form->help(LAN_METATAG_ADMIN_263),
				'field' => $form->text($field . '[video:director]', varset($values['data']['video:director'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_262,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:writer]'] = [
				'label' => LAN_METATAG_ADMIN_264,
				'help'  => $form->help(LAN_METATAG_ADMIN_265),
				'field' => $form->text($field . '[video:writer]', varset($values['data']['video:writer'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_264,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:duration]'] = [
				'label' => LAN_METATAG_ADMIN_266,
				'help'  => $form->help(LAN_METATAG_ADMIN_267),
				'field' => $form->text($field . '[video:duration]', varset($values['data']['video:duration'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_266,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:release_date]'] = [
				'label' => LAN_METATAG_ADMIN_268,
				'help'  => $form->help(LAN_METATAG_ADMIN_269),
				'field' => $form->text($field . '[video:release_date]', varset($values['data']['video:release_date'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_268,
					'class' => 'input-block-level',
				]),
			];
			...
			// TODO - use selectize instead.
			$opengraph[$field . '[video:tag]'] = [
				'label' => LAN_METATAG_ADMIN_270,
				'help'  => $form->help(LAN_METATAG_ADMIN_271),
				'field' => $form->text($field . '[video:tag]', varset($values['data']['video:tag'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_270,
					'class' => 'input-block-level',
				]),
			];

			$opengraph[$field . '[video:series]'] = [
				'label' => LAN_METATAG_ADMIN_272,
				'help'  => $form->help(LAN_METATAG_ADMIN_273),
				'field' => $form->text($field . '[video:series]', varset($values['data']['video:series'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_272,
					'class' => 'input-block-level',
				]),
			];
		...
		// Facebook meta tags.
		if (in_array('facebook', $this->enabled_groups)) {
			$facebook = [];

			$facebook[$field . '[fb:admins]'] = [
				'label' => LAN_METATAG_ADMIN_50,
				'help'  => $form->help(LAN_METATAG_ADMIN_51),
				'field' => $form->text($field . '[fb:admins]', varset($values['data']['fb:admins'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_50,
					'class' => 'input-block-level',
				]),
			];

			$facebook[$field . '[fb:app_id]'] = [
				'label' => LAN_METATAG_ADMIN_52,
				'help'  => $form->help(LAN_METATAG_ADMIN_53),
				'field' => $form->text($field . '[fb:app_id]', varset($values['data']['fb:app_id'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_52,
					'class' => 'input-block-level',
				]),
			];
		...
		if (in_array('twitter', $this->enabled_groups)) {
			$twitter = [];

			$twitter[$field . '[twitter:card]'] = [
				'label' => LAN_METATAG_ADMIN_90,
				'help'  => $form->help(LAN_METATAG_ADMIN_91),
				'field' => $form->select($field . '[twitter:card]', [
				...
				], varset($values['data']['twitter:card'], FALSE), [
					'label' => LAN_METATAG_ADMIN_90,
					'class' => 'input-block-level',
				], TRUE),
			];

			$twitter[$field . '[twitter:site:id]'] = [
				'label' => LAN_METATAG_ADMIN_94,
				'help'  => $form->help(LAN_METATAG_ADMIN_95),
				'field' => $form->text($field . '[twitter:site:id]', varset($values['data']['twitter:site:id'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_94,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:creator]'] = [
				'label' => LAN_METATAG_ADMIN_96,
				'help'  => $form->help(LAN_METATAG_ADMIN_97),
				'field' => $form->text($field . '[twitter:creator]', varset($values['data']['twitter:creator'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_96,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:creator:id]'] = [
				'label' => LAN_METATAG_ADMIN_98,
				'help'  => $form->help(LAN_METATAG_ADMIN_99),
				'field' => $form->text($field . '[twitter:creator:id]', varset($values['data']['twitter:creator:id'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_98,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:url]'] = [
				'label' => LAN_METATAG_ADMIN_100,
				'help'  => $form->help(LAN_METATAG_ADMIN_101),
				'field' => $form->text($field . '[twitter:url]', varset($values['data']['twitter:url'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_100,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:title]'] = [
				'label' => LAN_METATAG_ADMIN_102,
				'help'  => $form->help(LAN_METATAG_ADMIN_103),
				'field' => $form->text($field . '[twitter:title]', varset($values['data']['twitter:title'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_102,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:description]'] = [
				'label' => LAN_METATAG_ADMIN_104,
				'help'  => $form->help(LAN_METATAG_ADMIN_105),
				'field' => $form->text($field . '[twitter:description]', varset($values['data']['twitter:description'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_104,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image]'] = [
				'label' => LAN_METATAG_ADMIN_106,
				'help'  => $form->help(LAN_METATAG_ADMIN_107),
				'field' => $form->text($field . '[twitter:image]', varset($values['data']['twitter:image'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_106,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image:width]'] = [
				'label' => LAN_METATAG_ADMIN_108,
				'help'  => $form->help(LAN_METATAG_ADMIN_109),
				'field' => $form->text($field . '[twitter:image:width]', varset($values['data']['twitter:image:width'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_108,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image:height]'] = [
				'label' => LAN_METATAG_ADMIN_110,
				'help'  => $form->help(LAN_METATAG_ADMIN_111),
				'field' => $form->text($field . '[twitter:image:height]', varset($values['data']['twitter:image:height'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_110,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image:alt]'] = [
				'label' => LAN_METATAG_ADMIN_112,
				'help'  => $form->help(LAN_METATAG_ADMIN_113),
				'field' => $form->text($field . '[twitter:image:alt]', varset($values['data']['twitter:image:alt'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_112,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image0]'] = [
				'label' => LAN_METATAG_ADMIN_114,
				'help'  => $form->help(LAN_METATAG_ADMIN_115),
				'field' => $form->text($field . '[twitter:image0]', varset($values['data']['twitter:image0'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_114,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image1]'] = [
				'label' => LAN_METATAG_ADMIN_116,
				'help'  => $form->help(LAN_METATAG_ADMIN_117),
				'field' => $form->text($field . '[twitter:image1]', varset($values['data']['twitter:image1'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_116,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image2]'] = [
				'label' => LAN_METATAG_ADMIN_118,
				'help'  => $form->help(LAN_METATAG_ADMIN_119),
				'field' => $form->text($field . '[twitter:image2]', varset($values['data']['twitter:image2'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_118,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:image3]'] = [
				'label' => LAN_METATAG_ADMIN_120,
				'help'  => $form->help(LAN_METATAG_ADMIN_121),
				'field' => $form->text($field . '[twitter:image3]', varset($values['data']['twitter:image3'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_120,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:player]'] = [
				'label' => LAN_METATAG_ADMIN_122,
				'help'  => $form->help(LAN_METATAG_ADMIN_123),
				'field' => $form->text($field . '[twitter:player]', varset($values['data']['twitter:player'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_122,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:player:width]'] = [
				'label' => LAN_METATAG_ADMIN_124,
				'help'  => $form->help(LAN_METATAG_ADMIN_125),
				'field' => $form->text($field . '[twitter:player:width]', varset($values['data']['twitter:player:width'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_124,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:player:height]'] = [
				'label' => LAN_METATAG_ADMIN_126,
				'help'  => $form->help(LAN_METATAG_ADMIN_127),
				'field' => $form->text($field . '[twitter:player:height]', varset($values['data']['twitter:player:height'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_126,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:player:stream]'] = [
				'label' => LAN_METATAG_ADMIN_128,
				'help'  => $form->help(LAN_METATAG_ADMIN_129),
				'field' => $form->text($field . '[twitter:player:stream]', varset($values['data']['twitter:player:stream'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_128,
					'class' => 'input-block-level',
				]),
			];
			...
			$twitter[$field . '[twitter:player:stream:content_type]'] = [
				'label' => LAN_METATAG_ADMIN_130,
				'help'  => $form->help($help),
				'field' => $form->text($field . '[twitter:player:stream:content_type]', varset($values['data']['twitter:player:stream:content_type'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_130,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:country]'] = [
				'label' => LAN_METATAG_ADMIN_132,
				'help'  => $form->help(LAN_METATAG_ADMIN_133),
				'field' => $form->text($field . '[twitter:app:country]', varset($values['data']['twitter:app:country'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_132,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:name:iphone]'] = [
				'label' => LAN_METATAG_ADMIN_134,
				'help'  => $form->help(LAN_METATAG_ADMIN_135),
				'field' => $form->text($field . '[twitter:app:name:iphone]', varset($values['data']['twitter:app:name:iphone'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_134,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:id:iphone]'] = [
				'label' => LAN_METATAG_ADMIN_136,
				'help'  => $form->help(LAN_METATAG_ADMIN_137),
				'field' => $form->text($field . '[twitter:app:id:iphone]', varset($values['data']['twitter:app:id:iphone'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_136,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:url:iphone]'] = [
				'label' => LAN_METATAG_ADMIN_138,
				'help'  => $form->help(LAN_METATAG_ADMIN_139),
				'field' => $form->text($field . '[twitter:app:url:iphone]', varset($values['data']['twitter:app:url:iphone'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_138,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:name:ipad]'] = [
				'label' => LAN_METATAG_ADMIN_140,
				'help'  => $form->help(LAN_METATAG_ADMIN_141),
				'field' => $form->text($field . '[twitter:app:name:ipad]', varset($values['data']['twitter:app:name:ipad'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_140,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:id:ipad]'] = [
				'label' => LAN_METATAG_ADMIN_142,
				'help'  => $form->help(LAN_METATAG_ADMIN_143),
				'field' => $form->text($field . '[twitter:app:id:ipad]', varset($values['data']['twitter:app:id:ipad'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_142,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:url:ipad]'] = [
				'label' => LAN_METATAG_ADMIN_144,
				'help'  => $form->help(LAN_METATAG_ADMIN_145),
				'field' => $form->text($field . '[twitter:app:url:ipad]', varset($values['data']['twitter:app:url:ipad'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_144,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:name:googleplay]'] = [
				'label' => LAN_METATAG_ADMIN_146,
				'help'  => $form->help(LAN_METATAG_ADMIN_147),
				'field' => $form->text($field . '[twitter:app:name:googleplay]', varset($values['data']['twitter:app:name:googleplay'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_146,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:id:googleplay]'] = [
				'label' => LAN_METATAG_ADMIN_148,
				'help'  => $form->help(LAN_METATAG_ADMIN_149),
				'field' => $form->text($field . '[twitter:app:id:googleplay]', varset($values['data']['twitter:app:id:googleplay'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_148,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:app:url:googleplay]'] = [
				'label' => LAN_METATAG_ADMIN_150,
				'help'  => $form->help(LAN_METATAG_ADMIN_151),
				'field' => $form->text($field . '[twitter:app:url:googleplay]', varset($values['data']['twitter:app:url:googleplay'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_150,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:label1]'] = [
				'label' => LAN_METATAG_ADMIN_152,
				'help'  => $form->help(LAN_METATAG_ADMIN_153),
				'field' => $form->text($field . '[twitter:label1]', varset($values['data']['twitter:label1'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_152,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:data1]'] = [
				'label' => LAN_METATAG_ADMIN_154,
				'help'  => $form->help(LAN_METATAG_ADMIN_155),
				'field' => $form->text($field . '[twitter:data1]', varset($values['data']['twitter:data1'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_154,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:label2]'] = [
				'label' => LAN_METATAG_ADMIN_156,
				'help'  => $form->help(LAN_METATAG_ADMIN_157),
				'field' => $form->text($field . '[twitter:label2]', varset($values['data']['twitter:label2'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_156,
					'class' => 'input-block-level',
				]),
			];

			$twitter[$field . '[twitter:data2]'] = [
				'label' => LAN_METATAG_ADMIN_158,
				'help'  => $form->help(LAN_METATAG_ADMIN_159),
				'field' => $form->text($field . '[twitter:data2]', varset($values['data']['twitter:data2'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_158,
					'class' => 'input-block-level',
				]),
			];
		...
		if (in_array('dublin', $this->enabled_groups)) {
			$dublin = [];

			$dublin[$field . '[dcterms.title]'] = [
				'label' => LAN_METATAG_ADMIN_60,
				'help'  => $form->help(LAN_METATAG_ADMIN_61),
				'field' => $form->text($field . '[dcterms.title]', varset($values['data']['dcterms.title'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_60,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.creator]'] = [
				'label' => LAN_METATAG_ADMIN_62,
				'help'  => $form->help(LAN_METATAG_ADMIN_63),
				'field' => $form->text($field . '[dcterms.creator]', varset($values['data']['dcterms.creator'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_62,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.subject]'] = [
				'label' => LAN_METATAG_ADMIN_64,
				'help'  => $form->help(LAN_METATAG_ADMIN_65),
				'field' => $form->text($field . '[dcterms.subject]', varset($values['data']['dcterms.subject'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_64,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.description]'] = [
				'label' => LAN_METATAG_ADMIN_66,
				'help'  => $form->help(LAN_METATAG_ADMIN_67),
				'field' => $form->text($field . '[dcterms.description]', varset($values['data']['dcterms.description'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_66,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.publisher]'] = [
				'label' => LAN_METATAG_ADMIN_68,
				'help'  => $form->help(LAN_METATAG_ADMIN_69),
				'field' => $form->text($field . '[dcterms.publisher]', varset($values['data']['dcterms.publisher'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_68,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.contributor]'] = [
				'label' => LAN_METATAG_ADMIN_70,
				'help'  => $form->help(LAN_METATAG_ADMIN_71),
				'field' => $form->text($field . '[dcterms.contributor]', varset($values['data']['dcterms.contributor'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_70,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.date]'] = [
				'label' => LAN_METATAG_ADMIN_72,
				'help'  => $form->help(LAN_METATAG_ADMIN_73),
				'field' => $form->text($field . '[dcterms.date]', varset($values['data']['dcterms.date'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_72,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.type]'] = [
				'label' => LAN_METATAG_ADMIN_74,
				'help'  => $form->help(LAN_METATAG_ADMIN_75),
				'field' => $form->select($field . '[dcterms.type]', [
				...
				], varset($values['data']['dcterms.type'], FALSE), [
					'label' => LAN_METATAG_ADMIN_74,
					'class' => 'input-block-level',
				], TRUE),
			];

			$dublin[$field . '[dcterms.format]'] = [
				'label' => LAN_METATAG_ADMIN_76,
				'help'  => $form->help(LAN_METATAG_ADMIN_77),
				'field' => $form->text($field . '[dcterms.format]', varset($values['data']['dcterms.format'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_76,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.identifier]'] = [
				'label' => LAN_METATAG_ADMIN_78,
				'help'  => $form->help(LAN_METATAG_ADMIN_79),
				'field' => $form->text($field . '[dcterms.identifier]', varset($values['data']['dcterms.identifier'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_78,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.source]'] = [
				'label' => LAN_METATAG_ADMIN_80,
				'help'  => $form->help(LAN_METATAG_ADMIN_81),
				'field' => $form->text($field . '[dcterms.source]', varset($values['data']['dcterms.source'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_80,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.language]'] = [
				'label' => LAN_METATAG_ADMIN_76,
				'help'  => $form->help(LAN_METATAG_ADMIN_77),
				'field' => $form->text($field . '[dcterms.language]', varset($values['data']['dcterms.language'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_76,
					'class' => 'input-block-level',
				]),
			];
			...
			$dublin[$field . '[dcterms.relation]'] = [
				'label' => LAN_METATAG_ADMIN_84,
				'help'  => $form->help(LAN_METATAG_ADMIN_85),
				'field' => $form->text($field . '[dcterms.relation]', varset($values['data']['dcterms.relation'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_84,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.coverage]'] = [
				'label' => LAN_METATAG_ADMIN_86,
				'help'  => $form->help(LAN_METATAG_ADMIN_87),
				'field' => $form->text($field . '[dcterms.coverage]', varset($values['data']['dcterms.coverage'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_86,
					'class' => 'input-block-level',
				]),
			];

			$dublin[$field . '[dcterms.rights]'] = [
				'label' => LAN_METATAG_ADMIN_88,
				'help'  => $form->help(LAN_METATAG_ADMIN_89),
				'field' => $form->text($field . '[dcterms.rights]', varset($values['data']['dcterms.rights'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_88,
					'class' => 'input-block-level',
				]),
			];
		...
		if (in_array('google', $this->enabled_groups)) {
			$google = [];

			$google[$field . '[itemprop:name]'] = [
				'label' => LAN_METATAG_ADMIN_54,
				'help'  => $form->help(LAN_METATAG_ADMIN_55),
				'field' => $form->text($field . '[itemprop:name]', varset($values['data']['itemprop:name'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_54,
					'class' => 'input-block-level',
				]),
			];

			$google[$field . '[itemprop:description]'] = [
				'label' => LAN_METATAG_ADMIN_56,
				'help'  => $form->help(LAN_METATAG_ADMIN_57),
				'field' => $form->text($field . '[itemprop:description]', varset($values['data']['itemprop:description'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_56,
					'class' => 'input-block-level',
				]),
			];

			$google[$field . '[itemprop:image]'] = [
				'label' => LAN_METATAG_ADMIN_58,
				'help'  => $form->help(LAN_METATAG_ADMIN_59),
				'field' => $form->text($field . '[itemprop:image]', varset($values['data']['itemprop:image'], ''), 255, [
					'label' => LAN_METATAG_ADMIN_58,
					'class' => 'input-block-level',
				]),
			];
			...
			$help = $tp->lanVars(LAN_METATAG_ADMIN_PANEL_HELP_05, [
